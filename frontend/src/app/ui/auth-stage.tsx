    ...
    <div className="flex h-full flex-col justify-between gap-5">
      ...
      <section className="flex flex-col justify-between gap-5 xl:min-h-[calc(100vh-9rem)] xl:py-2">
        <div className="max-w-[56rem] space-y-4">
          ...
          <h2 className="max-w-[56rem] text-3xl font-semibold tracking-[-0.06em] text-white sm:text-4xl lg:text-6xl xl:text-[5.6rem] xl:leading-[0.92]">
            {title}
          </h2>
        ...
        <div className="w-full max-w-[48rem] rounded-[22px] border border-white/14 bg-white/10 p-5 shadow-[0_24px_54px_rgba(7,18,44,0.2)] backdrop-blur-xl sm:p-6">
          ...
          <div className="mt-5 space-y-4">
            <h3 className="max-w-[38rem] text-2xl font-semibold tracking-[-0.04em] text-white sm:text-3xl">
              {activeSlide.title}
            </h3>
